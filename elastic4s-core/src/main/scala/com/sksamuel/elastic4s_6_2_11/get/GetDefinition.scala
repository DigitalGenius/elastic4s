...
import com.sksamuel.elastic4s_6_2_11.{FetchSourceContext, IndexAndType, VersionType}
...
case class GetDefinition(indexAndType: IndexAndType,
  ...
  def preference(pref: com.sksamuel.elastic4s_6_2_11.Preference): GetDefinition = preference(pref.value)
