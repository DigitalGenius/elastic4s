...
import com.sksamuel.elastic4s_6_2_11.searches.queries.term._
import com.sksamuel.elastic4s_6_2_11.{DistanceUnit, DocumentRef, Indexable}
...
trait QueryApi {
  ...
  def termsSetQuery(field: String, terms: Set[Any]): com.sksamuel.elastic4s_6_2_11.searches.queries.term.TermsSetQuery =
    com.sksamuel.elastic4s_6_2_11.searches.queries.term.TermsSetQuery(field, terms)
