...
import com.sksamuel.elastic4s_6_2_11.script.ScriptFieldDefinition
import com.sksamuel.elastic4s_6_2_11.searches.aggs.AbstractAggregation
...
import com.sksamuel.elastic4s_6_2_11.searches.queries.matches.{MatchAllQueryDefinition, MatchQueryDefinition}
import com.sksamuel.elastic4s_6_2_11.searches.queries.term.TermQueryDefinition
import com.sksamuel.elastic4s_6_2_11.searches.sort.{FieldSortDefinition, SortDefinition}
import com.sksamuel.elastic4s_6_2_11.searches.suggestion.SuggestionDefinition
import com.sksamuel.elastic4s_6_2_11.{FetchSourceContext, IndexesAndTypes}
...
case class SearchDefinition(indexesTypes: IndexesAndTypes,
  ...
  def preference(pref: com.sksamuel.elastic4s_6_2_11.Preference): SearchDefinition = preference(pref.value)
