...
import com.sksamuel.elastic4s_6_2_11.http.SourceAsContentBuilder
import com.sksamuel.elastic4s_6_2_11.json.JacksonSupport
import com.sksamuel.elastic4s_6_2_11.searches.GeoPoint
import com.sksamuel.elastic4s_6_2_11.{AggReader, DocumentRef}

trait AggBucket extends HasAggregations {
  def docCount: Long
}

case class TermBucket(key: String, override val docCount: Long, private[elastic4s_6_2_11] val data: Map[String, Any])
...
case class HistogramBucket(key: Double, override val docCount: Long, private[elastic4s_6_2_11] val data: Map[String, Any])
    extends AggBucket
...
case class DateHistogramBucket(date: String,
                               ...
                               private[elastic4s_6_2_11] val data: Map[String, Any])
    extends AggBucket

case class DateRangeAggResult(name: String, buckets: Seq[DateRangeBucket]) extends BucketAggregation

object DateRangeAggResult {
  private[elastic4s_6_2_11] def apply(name: String, data: Map[String, Any]): DateRangeAggResult = DateRangeAggResult(
    name,
...
object KeyedDateRangeAggResult {
  ...
  private[elastic4s_6_2_11] def fromData(name: String, data: Map[String, Any]): KeyedDateRangeAggResult =
...
object DateRangeBucket {
  private[elastic4s_6_2_11] def apply(map: Map[String, Any]): DateRangeBucket = DateRangeBucket(
...
case class RangeAggResult(name: String, buckets: Seq[RangeBucket], private[elastic4s_6_2_11] val data: Map[String, Any])
    extends BucketAggregation
...
object RangeBucket {
  private[elastic4s_6_2_11] def apply(data: Map[String, Any]): RangeBucket = RangeBucket(
...
case class GeoHashGridBucket(key: String, override val docCount: Long, private[elastic4s_6_2_11] val data: Map[String, Any])
    extends AggBucket
...
case class TopHit(@JsonProperty("_index") index: String,
  ...
  override private[elastic4s_6_2_11] val data = source
}
...
case class ChildrenAggResult(name: String, docCount: Long, private[elastic4s_6_2_11] val data: Map[String, Any])
...
case class NestedAggResult(name: String, private[elastic4s_6_2_11] val data: Map[String, Any]) extends HasAggregations
...
trait HasAggregations extends Transformable {
  ...
  override private[elastic4s_6_2_11] def data: Map[String, Any]
...
trait Transformable {
  private[elastic4s_6_2_11] def data: Map[String, Any]
...
case class GlobalAggregationResult(name: String, docCount: Int, private[elastic4s_6_2_11] val data: Map[String, Any])
    extends BucketAggregation
    with HasAggregations

case class FilterAggregationResult(name: String, docCount: Int, private[elastic4s_6_2_11] val data: Map[String, Any])
    extends BucketAggregation
    with HasAggregations

case class UnnamedFilterAggregationResult(docCount: Long, private[elastic4s_6_2_11] val data: Map[String, Any])
    extends HasAggregations
