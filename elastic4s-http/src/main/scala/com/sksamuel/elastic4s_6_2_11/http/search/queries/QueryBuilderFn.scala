...
import com.sksamuel.elastic4s_6_2_11.http.search.RawQueryBodyFn
import com.sksamuel.elastic4s_6_2_11.http.search.queries.compound.{
  BoolQueryBuilderFn,
  BoostingQueryBodyFn,
  ConstantScoreBodyFn,
  DisMaxQueryBodyFn
}
import com.sksamuel.elastic4s_6_2_11.http.search.queries.geo.{
  GeoBoundingBoxQueryBodyFn,
  GeoDistanceQueryBodyFn,
  GeoPolyonQueryBodyFn,
  GeoShapeQueryBodyFn
}
import com.sksamuel.elastic4s_6_2_11.http.search.queries.nested.{
  HasChildBodyFn,
  HasParentBodyFn,
  NestedQueryBodyFn,
  ParentIdQueryBodyFn
}
import com.sksamuel.elastic4s_6_2_11.http.search.queries.span._
import com.sksamuel.elastic4s_6_2_11.http.search.queries.specialized.{
  FunctionScoreQueryBuilderFn,
  MoreLikeThisBuilderFn,
  ScriptQueryBodyFn,
  ScriptScoreQueryBodyFn
}
import com.sksamuel.elastic4s_6_2_11.http.search.queries.term._
import com.sksamuel.elastic4s_6_2_11.http.search.queries.text._
import com.sksamuel.elastic4s_6_2_11.json.XContentBuilder
import com.sksamuel.elastic4s_6_2_11.searches.queries.funcscorer.{FunctionScoreQueryDefinition, ScriptScoreDefinition}
import com.sksamuel.elastic4s_6_2_11.searches.queries.geo.{
...
import com.sksamuel.elastic4s_6_2_11.searches.queries.{IdQuery, _}
