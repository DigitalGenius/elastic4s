...
import com.sksamuel.elastic4s_6_2_11.searches.QueryRescoreMode.{Avg, Max, Min, Multiply, Total}
import com.sksamuel.elastic4s_6_2_11.searches.aggs.{HistogramOrder, SubAggCollectionMode, TermsOrder}
import com.sksamuel.elastic4s_6_2_11.searches.queries.funcscorer.{CombineFunction, FunctionScoreQueryScoreMode, MultiValueMode}
import com.sksamuel.elastic4s_6_2_11.searches.queries.geo.GeoDistance.{Arc, Plane}
import com.sksamuel.elastic4s_6_2_11.searches.queries.geo.{GeoDistance, GeoExecType, GeoValidationMethod}
import com.sksamuel.elastic4s_6_2_11.searches.queries.matches.MultiMatchQueryBuilderType.{
  BEST_FIELDS,
  CROSS_FIELDS,
  MOST_FIELDS,
  PHRASE,
...
import com.sksamuel.elastic4s_6_2_11.searches.queries.matches.{MultiMatchQueryBuilderType, ZeroTermsQuery}
import com.sksamuel.elastic4s_6_2_11.searches.queries.{RegexpFlag, SimpleQueryStringFlag}
import com.sksamuel.elastic4s_6_2_11.searches.sort.{SortMode, SortOrder}
import com.sksamuel.elastic4s_6_2_11.searches.suggestion.{Fuzziness, SortBy, StringDistanceImpl, SuggestMode}
import com.sksamuel.elastic4s_6_2_11.searches.{DateHistogramInterval, QueryRescoreMode, ScoreMode}
