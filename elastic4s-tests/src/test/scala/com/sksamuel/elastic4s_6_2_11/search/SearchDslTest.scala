...
import com.sksamuel.elastic4s_6_2_11.analyzers.{FrenchLanguageAnalyzer, SnowballAnalyzer, WhitespaceAnalyzer}
import com.sksamuel.elastic4s_6_2_11.searches.aggs.TermsOrder
import com.sksamuel.elastic4s_6_2_11.searches.queries.funcscorer.MultiValueMode
import com.sksamuel.elastic4s_6_2_11.searches.queries.geo.GeoDistance
...
import com.sksamuel.elastic4s_6_2_11.searches.suggestion.SuggestMode
...
class SearchDslTest extends FlatSpec with MockitoSugar with JsonSugar with OneInstancePerTest {
  ...
  it should "generate correct json for script sort" in {
    ...
    } preference com.sksamuel.elastic4s_6_2_11.Preference.Custom("custom-node")
