package com.sksamuel.elastic4s_6_2_11.aliases

import com.sksamuel.elastic4s_6_2_11.http.index.admin.{AliasActionResponse, AliasExistsResponse}
import com.sksamuel.elastic4s_6_2_11.http.index.alias.{Alias, IndexAliases}
